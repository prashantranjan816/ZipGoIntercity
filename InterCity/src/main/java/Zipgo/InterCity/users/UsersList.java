...
public class UsersList extends LoginPage{
	final static By users = By.xpath("//a[text()='Users']");
	final static By usersList = By.xpath("//a[text()='Users List']");
	String name;

	@Test(priority = 1, invocationCount = 1, enabled = true)
	public void usersList() throws IOException, InterruptedException {
		try {
